...
namespace Negrea_Georgiana_proiect.Models
{
    public class ProductCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Negrea_Georgiana_proiectContext context,
        Product product)
        {
        ...
        public void UpdateProductCategories(Negrea_Georgiana_proiectContext context,
